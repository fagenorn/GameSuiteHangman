...
public class TekeningHangManTest {
	...
	Vorm galgBodem = new Rechthoek(new Punt(10, 350), 300, 40);// altijd
																// zichtbaar
	Vorm galgStaaf = new LijnStuk(new Punt(160, 350), new Punt(160, 50));// altijd
																			// zichtbaar
	Vorm hangbar = new LijnStuk(new Punt(160, 50), new Punt(280, 50));// altijd
																		// zichtbaar
	Vorm koord = new LijnStuk(new Punt(280, 50), new Punt(280, 100));// altijd
																		// zichtbaar
